...
public class MainView extends JFrame  {
	...
	JButton btn_scan_all, btn_scan_simple, btn_view, btn_update, btn_quit, btn_isolation, btn_deltete;
	JTable table_view;
	JScrollPane sp;
	...
	public void init() {
		...
		btn_isolation = new JButton("Cách ly");
		btn_isolation.addActionListener(ac);
		btn_deltete = new JButton("Xoá");
		btn_deltete.addActionListener(ac);
		
		
		jPanel_bottom.add(btn_isolation);
